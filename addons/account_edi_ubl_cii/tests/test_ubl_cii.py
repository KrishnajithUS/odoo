...
class TestAccountEdiUblCii(AccountTestInvoicingCommon):
    ...
    def test_import_product(self):
        ...
        print_wiz = self.env["account.move.send"].create(
            {"move_ids": invoice.ids, "mail_template_id": template.id}
        )
    ...
    def test_import_tax_prediction(self):
        ...
        """
        self.env.ref("base.EUR").active = (
            True  # EUR might not be active and is used in the xml testing file
        )
