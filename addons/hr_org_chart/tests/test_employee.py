...
class TestEmployee(TestHrCommon):
    ...
    def test_is_subordinate(self):
        ...
        self.assertEqual(
            employees.filtered_domain(employees._search_is_subordinate("=", True)),
            self.employee_paul,
        )
        self.assertEqual(
            employees.filtered_domain(employees._search_is_subordinate("=", False)),
    ...
    def test_hierarchy_read(self):
        ...
        result = HrEmployee.hierarchy_read(
            [("id", "in", employees.ids)], ["id"], "parent_id"
        )
        ...
        for emp in employees:
            emp_dict = {
                ...
                and (emp.parent_id.id, emp.parent_id.display_name),
            }
        ...
        result = HrEmployee.hierarchy_read(
            [("id", "=", self.employee_paul.id)], ["id"], "parent_id"
        )
        self.assertEqual(len(result), 3)
        for emp in employees:
            emp_dict = {
        ...
        result = HrEmployee.hierarchy_read(
            [("id", "=", self.employee_georges.id)], ["id"], "parent_id"
        )
        self.assertEqual(len(result), 3)
        for emp in employees:
            emp_dict = {
        ...
        result = HrEmployee.hierarchy_read(
            [("id", "=", self.employee_pierre.id)], ["id"], "parent_id"
        )
        self.assertEqual(len(result), 2)
        self.assertIn(
            {
                "id": self.employee_pierre.id,
                "parent_id": (self.employee_georges.id, self.employee_georges.name),
            },
            result,
        )
        self.assertIn(
            {
                ...
                "parent_id": (self.employee_paul.id, self.employee_paul.name),
            },
            result,
        )
