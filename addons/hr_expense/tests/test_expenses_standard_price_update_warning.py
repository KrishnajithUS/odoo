...
class TestExpenseStandardPriceUpdateWarning(TestExpenseCommon):
    def test_expense_standard_price_update_warning(self):
        ...
        with Form(
            self.expense_cat_A, view="hr_expense.product_product_expense_form_view"
        ) as form:
        ...
        with Form(
            self.expense_cat_B, view="hr_expense.product_product_expense_form_view"
        ) as form:
            form.standard_price = 5
        ...
        with Form(
            self.expense_cat_C, view="hr_expense.product_product_expense_form_view"
        ) as form:
            form.standard_price = 5
            self.assertFalse(form.standard_price_update_warning)
    ...
    def test_compute_standard_price_update_warning_product_with_and_without_expense(
        ...
        (
            self.product_expensed | self.product_not_expensed
