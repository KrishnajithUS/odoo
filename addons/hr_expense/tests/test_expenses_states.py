...
class TestExpensesStates(TestExpenseCommon):
    ...
    def setUpClass(cls, chart_template_ref=None):
        ...
        cls.expense_states_sheets = (
            cls.expense_states_employee_sheet + cls.expense_states_company_sheet
        )
    ...
    def test_expense_state_synchro_1_regular_flow(self):
        ...
        self.assertRecordValues(
            self.expense_states_sheets.expense_line_ids,
            [
        ...
        self.assertRecordValues(
            self.expense_states_sheets.account_move_ids,
            [
                {"state": "posted"},
                {"state": "posted"},
            ],
    ...
    def test_expense_state_synchro_2_employee_specific_flow(self):
        ...
        self.assertRecordValues(
            self.expense_states_employee_sheet.expense_line_ids,
            [
                {"state": "approved"},
            ],
        )
        self.assertRecordValues(
            self.expense_states_employee_sheet,
            [
                {"state": "post", "payment_state": "not_paid"},
            ],
        )
        self.assertRecordValues(
            self.expense_states_employee_sheet.account_move_ids,
            [
                {"state": "draft"},
            ],
        )
        ...
        self.expense_states_employee_sheet.action_sheet_move_create()
        action_context = self.expense_states_employee_sheet.action_register_payment()[
            "context"
        ]
    ...
    def test_expense_state_synchro_3_company_specific_flow(self):
        ...
        self.assertRecordValues(
            self.expense_states_company_sheet.expense_line_ids,
            [
                {"state": "done"},
            ],
        )
        self.assertRecordValues(
            self.expense_states_company_sheet,
            [
                {"state": "done", "payment_state": "paid"},
            ],
        )
        self.assertRecordValues(
            self.expense_states_company_sheet.account_move_ids,
            [
                {"state": "draft"},
            ],
        )
