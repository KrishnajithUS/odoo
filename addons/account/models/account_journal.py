...
class AccountJournalGroup(models.Model):
    ...
    excluded_journal_ids = fields.Many2many(
        "account.journal", string="Excluded Journals", check_company=True
    )
...
class AccountJournal(models.Model):
    ...
    journal_group_ids = fields.Many2many(
        "account.journal.group", check_company=True, string="Journal Groups"
    )
    ...
    def _alias_get_creation_values(self):
        ...
        if self.id:
            ...
            defaults["move_type"] = (
                "in_invoice" if self.type == "purchase" else "out_invoice"
            )
    ...
    @api.model
    def get_next_bank_cash_default_code(
    ...
    def _fill_missing_values(self, vals, protected_codes=False):
        ...
        if is_import and not vals.get("code"):
            ...
            vals["code"] = (
                ...
                else self.get_next_bank_cash_default_code(
