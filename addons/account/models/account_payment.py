...
class AccountPayment(models.Model):
    ...
    def _get_valid_liquidity_accounts(self):
        ...
        accessible_branches = journal_comp.with_company(
            journal_comp
    ...
    def create(self, vals_list):
        ...
        for vals in vals_list:
            ...
            vals["journal_id"] = (
                vals.get("journal_id")
                or self.move_id.with_context(is_payment=True)
    ...
    def _create_paired_internal_transfer_payment(self):
        ...
        for payment in self:
            ...
            body = (
                _("A second payment has been created:")
