...
class AccountPaymentRegister(models.TransientModel):
    ...
    def _get_line_batch_key(self, line):
        ...
        return {
            ...
            "partner_type": (
                "customer" if line.account_type == "asset_receivable" else "supplier"
            ),
        }
        ...
        for wizard in self:
            ...
            for batch in batches:
                ...
                if (
                    ...
                    and not batch_account.allow_out_payment
                ):
    ...
    def _compute_from_lines(self):
        ...
        for wizard in self:
            ...
            if len(batches) == 1:
                ...
                wizard.update(
                    {
                        "company_id": batches[0]["lines"][0]
                        .company_id._accessible_branches()[:1]
                        .id,
                        "partner_id": False,
                        "partner_type": False,
    ...
    def _create_payments(self):
        ...
        if not batches:
            raise UserError(
                _(
                    "To record payments with %s, the recipient bank account must be manually validated. You should go on the partner bank account in order to validate it.",
