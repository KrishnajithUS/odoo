...
class EmployeePublic(models.Model):
    ...
    def _search_first_contract_date(self, operator, value):
        employees = (
            ...
            .search(
                [
                    ("id", "child_of", self.env.user.employee_id.ids),
...
class Employee(models.Model):
    ...
    def _get_unusual_days(self, date_from, date_to=None):
        ...
        for contract in employee_contracts:
            ...
            tmp_date_to = (
                min(date_to_date, contract.date_end)
                if contract.date_end
                else date_to_date
            )
            unusual_days.update(
                contract.resource_calendar_id.sudo(False)._get_unusual_days(
                    datetime.combine(
    ...
    def _get_calendar_attendances(self, date_from, date_to):
        ...
        for contract in valid_contracts:
            ...
            contract_duration_data = calendar.with_context(
